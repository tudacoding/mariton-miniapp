        ...
        <HomeLayout>
            ...
            <div className="w-full absolute items-center content-center justify-center top-20 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-center">
                <div className="absolute top-10 w-full">
                    <img className="absolute top-0 z-10 transform left-1/2 -translate-x-1/2 flex flex-col items-center"
                        src={bodyBgLottery} />
                    <img className="absolute -top-16 z-10 transform scale-50 flex flex-col items-center" src={mainBanner} />
                </div>
            </div>
