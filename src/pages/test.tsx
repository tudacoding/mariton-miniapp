  ...
  return (
    <div className="h-screen">
      ...
      <div className="mt-2 flex space-x-1">
        <button
          className="h-10 bg-orange-500 hover:bg-orange-700 text-white font-bold py-1 px-6 rounded-md"
          onClick={mintMRT}
        >
          Mint MRT
        </button>
        <button
          className="h-10 bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-6 rounded-md"
          onClick={handleClaim}
        >
          Claim MRT
        </button>
      ...
      <div className="mt-2 flex space-x-1">
        ...
        <button className="h-10 bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-6 rounded-md">
          Withdraw MRT
        </button>
        <button
          className="h-10 bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-6 rounded-md"
          onClick={withdrawTon}
        >
          Withdraw TON
        </button>
